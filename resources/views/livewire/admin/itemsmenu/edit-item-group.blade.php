<div>
    ...
    <x-slot name="breadcrumbs">
        <x-breadcrumbs :items="[
            ...
            [
                'url'   => route('admin.itemsmenu.item-group.edit', ['id' => $itemGroup->id]),
                'label' => __('admin.titles.itemsmenu.edit_item_group'),
            ]
        ]" />
    </x-slot>
    ...
    <x-containers.main>
        <x-containers.title>
            {{ __('admin.titles.itemsmenu.edit_item_group') }}
        </x-containers.title>
        ...
        <div class="mt-6">
            ...
            <div class="flex justify-end items-center gap-x-4 mt-6">
                ...
                <x-buttons.primary-button wire:click="updateItemGroup">
