    ...
    <x-containers.main class="mt-4" x-data="{open: true}">
        <div class="flex justify-between">
            ...
            <div class="flex items-center gap-x-4" x-show="open">
                ...
                <x-buttons.primary-button size="sm" href="{{ route('admin.players.add-plot', ['uuid' => $player->uuid]) }}">{{ __('general.buttons.add') }}</x-buttons.primary-button>
            </div>
        </div>
    ...
    <x-containers.main class="mt-4" x-data="{open: true}">
        <div class="flex justify-between">
            ...
            <div class="flex items-center gap-x-4" x-show="open">
                ...
                <x-buttons.primary-button size="sm" href="{{ route('admin.players.add-company', ['uuid' => $player->uuid]) }}">{{ __('general.buttons.add') }}</x-buttons.primary-button>
            </div>
        </div>
