<div>
    <x-slot name="breadcrumbs">
        <x-breadcrumbs :items="[
            ...
            [
                'icon' => '',
                'url' => route('admin.countries.edit', ['id' => $this->country->id]),
                'label' => __('admin.titles.countries.edit'),
            ],
        ]" />
    </x-slot>
    ...
    <x-containers.main>
        <x-containers.title>
            {{ __('admin.titles.countries.edit') }}
        </x-containers.title>
        ...
        <div class="mt-6">
            ...
            <div class="flex justify-end items-center gap-x-4">
                ...
                <x-buttons.primary-button wire:click="updateCountry">
