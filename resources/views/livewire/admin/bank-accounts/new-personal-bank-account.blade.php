<div>
    ...
    <x-slot name="breadcrumbs">
        <x-breadcrumbs :items="[
            ...
            [
                'url'   => route('admin.bank-accounts.personal.new'),
                'label' => __('admin.titles.bank_accounts.personal.create'),
            ]
        ]" />
    </x-slot>
        ...
        <div class="mt-6">
            <div class="grid grid-cols-4 gap-x-4 gap-y-6">
                ...
                <div class="col-span-1">
                    ...
                    <livewire:async-select
                        :options="collect(value: ['Checking', 'Savings'])->map(fn($type) => ['label' => $type, 'value' => $type])"
                        wire:model="type"
                        :min-search-length="2"
                    />
                </div>
            ...
            <div class="flex justify-end items-center gap-x-4">
                ...
                <x-buttons.primary-button wire:click="createPersonalBankAccount">
