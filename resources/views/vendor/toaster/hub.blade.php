    ...
    <template x-for="toast in toasts" :key="toast.id">
        ...
        >
            ...
            {{-- <i x-text="toast.message"
               class="inline-block select-none not-italic px-6 py-3 rounded rounded-sm shadow-lg text-md border-s border-default w-full {{ $alignment->is('bottom') ? 'mt-3' : 'mb-3' }}"
               :class="toast.select({ error: 'bg-red-500', info: 'bg-neutral-primary-soft', success: 'bg-green-400', warning: 'bg-orange-500' })"
            ></i>
