...
>
    ...
    <div class="las-relative las-w-full">
        ...
        <div
            ...
            las-cursor-text las-items-center rounded-base {{-- $suffixButtonClass --}} {{-- las-rounded-l-md --}}
                ...
                @else
                    ...
                    @else
                        ...
                        <input
                            ...
                            class="las-w-full las-border-0 las-bg-transparent las-p-0 las-text-base las-text-gray-900 placeholder:las-text-gray-400 focus:las-outline-none focus:las-ring-0 cursor-pointer"
                            x-on:click="openDropdown()"
                            autocomplete="off"
                        >
                        @endif
                        ...
                        @foreach ($groupOptions as $option)
                            ...
                            >
                                ...
                                @else
                                    ...
                                    <span class="las-flex-1 las-truncate cursor-pointer">{{ $optionLabel }}</span>
